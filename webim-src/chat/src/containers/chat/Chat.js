...
class Chat extends React.Component {
    ...
    render() {
        ...
        const messageList = _.uniqBy(this.props.messageList, 'id')
        ...
        const renderName = function (name, type) {
            ...
            (Object.keys(group.byId) || []).forEach(element => {
                if (element == name) {
                    flag = true
                    userName = group.byId[name].groupName
                }
            });

            if (!flag) {
                userName = getOrganizeUserName(organize, name)
            }
        ...
        return (
            <div className="x-chat">
                ...
                <div className="x-chat-content" ref="x-chat-content" onScroll={this.handleScroll}>
                    ...
                    {_.map(messageList, message => <ChatMessage key={message.id} group={group} organize={this.props.organize} employee={employee} {...message} />)}
                </div>
